      ...
      <Layout>
        ...
        <LayoutHeader className='sticky top-0 justify-between px-4 py-3 md:px-4'>
          <div className={`flex items-center ${!isCollapsed ? 'gap-2' : ''}`}>
            ...
            >
              <span className='font-medium'>Sistem Pakar Admin</span>
        ...
        <Nav
          id='sidebar-menu'
          className={`h-full flex-1 overflow-auto no-scrollbar ${navOpened ? 'max-h-screen' : 'max-h-0 py-0 md:max-h-screen md:py-2'}`}
