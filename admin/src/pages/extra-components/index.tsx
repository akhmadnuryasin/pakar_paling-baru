...
export default function ExtraComponents() {
  const items = [
    ...
    <BreadcrumbItem key={title}>
      {href ? (
        <Link
          className='underline text-muted-foreground decoration-muted-foreground decoration-dashed underline-offset-4 hover:text-foreground hover:decoration-solid'
          to={href}
        >
          {title}
        </Link>
          ...
          <div className='flex-1'>
            ...
            <Tabs defaultValue='preview'>
              ...
              <TabsContent value='preview'>
                <div className='flex items-center justify-center border rounded min-h-56'>
                  <PinInput
